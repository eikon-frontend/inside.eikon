...
function Edit({
  ...
  const [selectedSection, setSelectedSection] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  const [selectedSubject, setSelectedSubject] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  ...
  const postOptions = posts ? posts.map(post => ({
    ...
    sectionId: post.acf?.section,
    subjectId: post.acf?.subjects
  })) : [];
  ...
  const onDragEnd = result => {
    ...
    const items = reorder(selectedPosts, result.source.index, result.destination.index);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_beautiful_dnd__WEBPACK_IMPORTED_MODULE_5__.DragDropContext, {
    ...
    className: "filters"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, "Filtrer les projets par taxonomies"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    value: selectedYear,
    onChange: handleYearChange
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    value: ""
  }, "Ann\xE9es"), years && years.map(year => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    key: year.id,
    value: year.id
  }, year.name))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    value: selectedSection,
    onChange: handleSectionChange
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    value: ""
  }, "Sections"), sections && sections.map(section => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    key: section.id,
    value: section.id
  }, section.name))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    value: selectedSubject,
    onChange: handleSubjectChange
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    value: ""
  }, "Subjects"), subjects && subjects.map(subject => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
    key: subject.id,
    value: subject.id
  }, subject.name)))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      display: 'flex',
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, "Liste des projets"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "list-projects list-projects-available"
  }, postOptions.filter(option => selectedYear == "" || option.yearId == selectedYear).filter(option => selectedSection == "" || option.sectionId == selectedSection).filter(option => selectedSubject == "" || option.subjectId == selectedSubject).filter(option => !selectedOptions.map(post => post.value).includes(option.value)).map((option, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: index,
    value: option.value,
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, "Selected project"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_beautiful_dnd__WEBPACK_IMPORTED_MODULE_5__.Droppable, {
  ...
  }, selectedPosts.map((post, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_beautiful_dnd__WEBPACK_IMPORTED_MODULE_5__.Draggable, {
    key: post.id,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.withSelect)(select => {
  ...
  const sections = getEntityRecords("taxonomy", "section", {
    per_page: -1
  });
  const subjects = getEntityRecords("taxonomy", "subjects", {
    per_page: -1
  });
  return {
    posts,
...
function save({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    "data-post-ids": JSON.stringify(postIds)
  });
}
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"eikonblocks/projects-dynamic","version":"0.1.0","title":"Projects block dynamic","category":"widgets","icon":"welcome-widgets-menus","description":"Project block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"textdomain":"eikonblocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js","attributes":{"selectedPosts":{"type":"array","default":[]},"selectedOptions":{"type":"array","default":[]}}}');
