...
function Edit({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_beautiful_dnd__WEBPACK_IMPORTED_MODULE_6__.DragDropContext, {
    onDragEnd: onDragEnd
  ...
  }, postOptions.filter(option => !selectedOptions.map(post => post.value).includes(option.value)).map((option, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: index,
    value: option.value,
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, "Projets s\xE9lectionn\xE9s"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_beautiful_dnd__WEBPACK_IMPORTED_MODULE_6__.Droppable, {
  ...
  }, selectedPosts.map((post, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_beautiful_dnd__WEBPACK_IMPORTED_MODULE_6__.Draggable, {
    key: post.id,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.withSelect)(select => {
  ...
  const posts = getEntityRecords("postType", "department", {
    per_page: -1
  });
  return {
    posts
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"eikonblocks/departments-teaser","version":"0.1.0","title":"Departments block dynamic","category":"widgets","icon":"welcome-learn-more","description":"Departments block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"textdomain":"eikonblocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","attributes":{"selectedPosts":{"type":"array","default":[]},"selectedOptions":{"type":"array","default":[]}}}');
